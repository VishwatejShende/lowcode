export default function BlockRenderer({ component }) {
    ...
    switch (type) {
        case 'Text':
            return (
                <div style={{ ...style, color: props.color || '#f1f5f9', fontSize: props.fontSize || 16, padding: 12, display: 'flex', alignItems: 'center' }}>
        ...
        case 'Button':
            return (
                <div style={{ ...style, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                    <button style={{ background: props.bg || '#388bfd', color: '#fff', padding: '8px 20px', borderRadius: 8, fontWeight: 600, fontSize: props.fontSize || 14, border: 'none', cursor: 'pointer' }}>
        ...
        case 'Image':
            return (
                <div style={style}>
                    <img src={props.src || 'https://placehold.co/400x200'} alt={props.alt || ''} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                </div>
            );
        case 'Card':
            return (
                <div style={{ ...style, background: '#1c2028', border: '1px solid #2a2f3a', borderRadius: 12, padding: 16 }}>
        ...
        case 'Hero':
            return (
                <div style={{ ...style, background: props.bg || 'linear-gradient(135deg,#1c2028,#0f1117)', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', textAlign: 'center', padding: 24, gap: 12 }}>
        ...
        case 'Navbar':
            return (
                <div style={{ ...style, background: props.bg || '#1c2028', borderBottom: '1px solid #2a2f3a', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 24px' }}>
        ...
        case 'Footer':
            return (
                <div style={{ ...style, background: props.bg || '#1c2028', borderTop: '1px solid #2a2f3a', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#6b7280', fontSize: 14 }}>
                    {props.text || '© 2025 BuildFlow'}
                </div>
            );
        case 'Input':
            return (
                <div style={{ ...style, display: 'flex', alignItems: 'center', padding: 12 }}>
                    <input 
                        type="text" 
        ...
        case 'Container':
            return (
                <div style={{ ...style, background: props.bg || 'rgba(44,47,59,0.5)', borderRadius: props.borderRadius ? `${props.borderRadius}px` : 0, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: 16 }}>
        ...
        case 'Grid':
            ...
            return (
                <div style={{ ...style, display: 'grid', gridTemplateColumns: `repeat(${cols}, 1fr)`, gap: 16, padding: 16 }}>
                    ...
                    {cols > 2 && <div style={{ background: '#1c2028', border: '1px solid #2a2f3a', borderRadius: 8, padding: 16, textAlign: 'center', color: '#6b7280', fontSize: 12 }}>Item 3</div>}
                </div>
            );
        default:
            return null;
